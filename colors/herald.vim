...
elseif &t_Co == 256
	...
	" -> Menu
	hi Pmenu          ctermbg=0    ctermfg=84    cterm=none
	...
	" -> Tabs
	hi TabLine        ctermbg=0  ctermfg=84   cterm=none
	hi TabLineFill    ctermbg=0                  cterm=none
	hi TabLineSel     ctermbg=60  ctermfg=203   cterm=bold 
	"
	" -> Visual Mode
	...
	" -> Code
	hi Comment        ctermbg=234  ctermfg=84   cterm=none
